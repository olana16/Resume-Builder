import { FilePenLineIcon, PencilIcon, PlugIcon, PlusIcon, TrashIcon, UploadCloudIcon, XIcon } from 'lucide-react';
                    ...
                    showCreateResume && (
                        ...
                        justify-center'>
                            <div onClick={e=>e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
                                ...
                                <input type="text" placeholder='Enter Resume title' className='w-full px-4 py-2 mb-4 
