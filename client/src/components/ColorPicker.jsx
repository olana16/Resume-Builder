                    ...
                    <div className='grid grid-cols-4 w-60 gap-2 absolute top-full left-0
                               right-0 p-3 mt-2 z-10 bg-white rounded-md border border-gray-200 shadow-sm'>
                                ...
                                {colors.map((color)=>(
                                    ...
                                    group flex flex-col' onClick={()=>{onChange(color.value)}}>

                                        <div className="w-12 h-12 rounded-full border-2 border-transparent
                                            group-hover:black/25 transition-colors" style={{background: color.value}}>
                                       ...
                                       <div className='absolute top-0 left-0 bottom-4.5
