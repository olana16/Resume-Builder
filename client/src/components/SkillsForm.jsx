...
const SkillsForm = ({data,Onchange}) => {
  ...
  return (
    ...
    <div className='bg-blue-50 p-3 rounded-lg'>
        <p className='text-sm text-blue-800'> <strong>Tips</strong>
            Add 8-12 relevant skills that highlight your expertise and make
             your profile stand out to potential employers.
        </p>
    </div>
